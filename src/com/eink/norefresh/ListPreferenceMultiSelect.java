 ...
 *
 * @contributor matiboy Added support for check all/none and custom separator defined
 * in XML. IMPORTANT: The following attributes MUST be defined (probably inside
 * attr.xml) for the code to even compile <declare-styleable
 * name="ListPreferenceMultiSelect"> <attr format="string" name="checkAll" /> <attr
 * format="string" name="separator" /> </declare-styleable> Whether you decide to
...
//        super.onDialogClosed(positiveResult);
     ...
     * @param separator Separator string. If null, static default separator will be
     * used
