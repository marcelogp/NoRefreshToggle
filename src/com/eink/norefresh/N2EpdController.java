...
public class N2EpdController
{
    ...
    public static void exitA2Mode() {
        System.err.println("NoRefreshToggle::exitA2Mode");
        vCurrentNode = 0;
        try {
...
//				System.err.println("EpdController Region Enum successfully retrived.");
            ...
            epdControllerSetRegionMethod.invoke(null, new Object[]{"NoRefreshToggle", regionEnums[2], localRegionParams});
    ...
    public static void enterA2Mode() {
        System.err.println("NoRefreshToggle::enterA2Mode");
...
//		System.err.println("NoRefreshToggle::setGL16Mode");
        try {
            /*
...
//				System.err.println("EpdController resetting.");
                epdControllerSetRegionMethod.invoke(null, new Object[]{"NoRefreshToggle",
...
//			System.err.println("set " + String.valueOf(vCurrentNode));
    ...
    public static void setDUMode() {
        System.err.println("NoRefreshToggle::setDUMode");
        System.err.println(vCurrentNode);
        try {
            Class epdControllerClass = Class.forName("android.hardware.EpdController");
            Class epdControllerRegionClass = Class.forName("android.hardware.EpdController$Region");
